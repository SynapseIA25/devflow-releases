...
import { Users, MessageSquare, Sparkles, Play, Square, Network, Boxes, Cpu, Timer } from "lucide-react";
import { DelegateStepList } from "../components/DelegateStepList";
      ...
      <div className="team-router">
        ...
        {mode === "delegate" && (
          <div className="team-delegate">
            ...
            {steps.length > 0 && <DelegateStepList steps={steps} running={running} />}
          </div>
        )}
      </div>
